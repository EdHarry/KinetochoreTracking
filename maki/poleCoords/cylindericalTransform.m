function [eflag,poleCoord,pole1Track,pole2Track] = cylindericalTransform(planeFit,tracks,sisterList)
%poles find poles
...
maxAngle=30*pi()/180; % max pole search angle (degrees in radians)
