function makiTestAlignment_pole(dataStruct,what2plot,whichRotation)
%TESTROTATION ...
%
...
rotationInfo.tracks = dataStruct.tracks_pole;
...
switch whichRotation
    case 1
        rotationInfo.planeFit = dataStruct.planeFit_pole;
    case 2
        rotationInfo.frameAlignment = dataStruct.frameAlignment_pole;
end
