...
% Voxels positions X
posX = ( uPosX - ...
    this.mImarisApplication.GetDataSet.GetExtendMinX ) ./ voxelSizes( 1 ) + 0.5;

% Voxels positions Y
posY = ( uPosY - ...
    this.mImarisApplication.GetDataSet.GetExtendMinY ) ./ voxelSizes( 2 ) + 0.5;

% Voxels positions Z
posZ = ( uPosZ - ...
    this.mImarisApplication.GetDataSet.GetExtendMinZ ) ./ voxelSizes( 3 ) + 0.5;
