function makiMovieAnalysisCentrinTrack(serverType,job,movieType)
    ...
    for iJob = 1:nJobs
        ...
        try
            ...
            if any(jobs2do == 3)
                ...
                job(iJob).dataStruct = makiInitCoordCentrinTrack(job(iJob).dataStruct,[],movieType);
            ...
            if any(jobs2do == 6)
                ...
                %pass and retrieve dataStruct
                job(iJob).dataStruct = makiGenerateTracksCentrinTrack(job(iJob).dataStruct);
