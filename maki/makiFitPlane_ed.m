function [dataStruct,m] = makiFitPlane_ed(dataStruct,verbose)
...
if length(framesWiPlane) > 1
   ...
   %output struct of rotation and error matricies - EH
        m(iTime).rot_m = rotationMat;
        m(iTime).err_m = errorPropMat;
    end
