function dataStruct = makiFindAllPoles( dataStruct )
...
if ~isempty(falseSis)
    ...
    % copy out dependencies (if they exist)
    if isfield(sisterList(1),'dependencies');
        depExist = 1;
        dependencies = sisterList(1).dependencies;
    else
        depExist = 0;
    end
