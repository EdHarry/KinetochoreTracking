function [job,basePath] = makiMakeJobOME_auto(jobType,status,job,ask4input,movieType)
...
% % %                  Optional. Default: 1.
% % %
% % %       movieType: 1 for deltaVision files, 2 for metamorph stacks, 3 for OME TIFFs.
% % %                  Optional. Default: 3.
% % %
        ...
        for iJob = 1:nJobs
            ...
            switch movieType
                ...
                case 3
                    ...
                    extIdx = regexp(rawMovieName,extIdx{1},'end') + 1;
            end
            ...
            elseif movieType == 1
                ...
                if size(logFile,1) > 1
                    ...
                    if ~isempty(logFile)
                        ...
                        % commented out by Ed 14/04/10 (for fire and forget job setup)
