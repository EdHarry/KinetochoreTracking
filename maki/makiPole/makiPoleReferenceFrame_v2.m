function dataStruct = makiPoleReferenceFrame_v2( dataStruct,useAlignedCoords4Gaps )
...
if ~isempty(noPoles)
    ...
    for frame = noPoles
        ...
        spotsToTransform = find(~ismember(1:size(allCoord,1),poleSpotIdx));
