function makiMovieAnalysis_pole(serverType,job,movieType)
...
%                                  end
          ...
          %   overwritten again
            ...
            if any(jobs2do == 16)
                ...
                %pass and retrieve dataStruct
                job(iJob).dataStruct = makiAlignFrames_pole(job(iJob).dataStruct);
            ...
            if any(jobs2do == 17)
                ...
                if success
                    ...
                    error('unable to secure-save sisterList_pole_nonAligned');
                end
                
            else
                
                % write temporarily a zero to history.sisterList_pole_nonAligned
                % Dependent on the jobs to follow, this field might be
                % overwritten again
