function gaussListOutput = GaussListND_mexCode_(coordList,sigma,centerInput)
...
normN = (2*pi)^(0.5*nDims)*prod(sigma2(1,:));
...
for gaussIdx = 1:nGauss
    ...
    center2 = repmat(centerInput(gaussIdx,:), [nCoords,1]);
    ...
    coordList2 = (coordList- center2)./sigma2;
