START_DIR = /Users/edwardharry/Documents/MATLAB/spotFit/mexTest

MATLAB_ROOT = /Applications/MATLAB_R2013b.app
MAKEFILE = mmfMex_mex.mk

include mmfMex_mex.mki
...
MEX_FILE_NAME_WO_EXT = mmfMex_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mmfMex"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mmfMex/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mmfMex/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mmfMex/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mmfMex/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
