...
%CLUSTERSPOT cluster spots based on the theoretical psf size or the corrected psf size.
%
...
% Revision by EHarry 19/11/12, if working in 3D will warp z coordinates so can use a single distance cutoff (assuming psf in x and y are the same)    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
