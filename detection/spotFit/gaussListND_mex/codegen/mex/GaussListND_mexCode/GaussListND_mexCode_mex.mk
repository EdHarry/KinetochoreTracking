...
MAKEFILE = GaussListND_mexCode_mex.mk

include GaussListND_mexCode_mex.mki
...
MEX_FILE_NAME_WO_EXT = GaussListND_mexCode_mex
...
SYS_INCLUDE += -I "/Users/edwardharry/Documents/MATLAB/spotFit/gaussListND_mex/codegen/mex/GaussListND_mexCode"
...
%.$(OBJEXT) : /Users/edwardharry/Documents/MATLAB/spotFit/gaussListND_mex/codegen/mex/GaussListND_mexCode/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/edwardharry/Documents/MATLAB/spotFit/gaussListND_mex/codegen/mex/GaussListND_mexCode/%.cu
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/edwardharry/Documents/MATLAB/spotFit/gaussListND_mex/codegen/mex/GaussListND_mexCode/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
