...
[ movieParam , detectParam ] = makeMoveAndDetectParamFromDataStruct( dataStruct, 1 , [] , [] , [] , [], [], 0, [] , struct('alphaR',0.01,'alphaA',0.01,'alphaD',0.01,'alphaF',0), 1e-7 );


% then run fitting
[movieInfo,exceptions,localMaxima,~,psfSigma] = detectSpots_newVersion(movieParam,detectParam,'no');
