function [detectedFeatures,clustersMMF,imageN3,errFlag] = ...
    detectSubResFeatures3D_new(image,cands,psfSigma,testAlpha,visual,...
...
options = [1E-03, 1E-6, 1E-6, 1E-6, 1E-06, sparselm_spsolvr('cholmod')];
...
for i = 1 : numClusters
    ...
    while fit
        ...
        [solutionT, residualsT, jacMatT] = sparseLMSolver(options,x0,imageC,clusterPixels,psfSigma,[numPixelsX,numPixelsY,numPixelsZ],clusters(i).pixels(:,4));
    ...
    if keepCluster(i)
        ...
        while testAmp
            ...
            if numMaxima > 1
                ...
                %    clusterPixels,psfSigma);
                %jacMat = full(jacMat);
		[solution, residuals, jacMat] = sparseLMSolver(options,x0,imageC,clusterPixels,psfSigma,[numPixelsX,numPixelsY,numPixelsZ],clusters(i).pixels(:,4));
