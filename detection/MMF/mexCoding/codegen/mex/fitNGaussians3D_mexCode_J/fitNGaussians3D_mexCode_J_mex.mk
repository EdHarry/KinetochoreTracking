...
MAKEFILE = fitNGaussians3D_mexCode_J_mex.mk

include fitNGaussians3D_mexCode_J_mex.mki
...
SRC_FILES =  \
	...
	exp.c \
	squeeze.c \
	fitNGaussians3D_mexCode_J_initialize.c \
	fitNGaussians3D_mexCode_J_terminate.c \
	fitNGaussians3D_mexCode_J_api.c \
	fitNGaussians3D_mexCode_J_emxutil.c \
	fitNGaussians3D_mexCode_J_mex.c

MEX_FILE_NAME_WO_EXT = fitNGaussians3D_mexCode_J_mex
...
SYS_INCLUDE += -I "/gpfs/home/sysbio/msrfby/MATLAB/MATLAB/newTracking/detection/MMF/mexCoding/codegen/mex/fitNGaussians3D_mexCode_J"
...
%.$(OBJEXT) : /gpfs/home/sysbio/msrfby/MATLAB/MATLAB/newTracking/detection/MMF/mexCoding/codegen/mex/fitNGaussians3D_mexCode_J/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /gpfs/home/sysbio/msrfby/MATLAB/MATLAB/newTracking/detection/MMF/mexCoding/codegen/mex/fitNGaussians3D_mexCode_J/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
