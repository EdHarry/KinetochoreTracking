function overlayImageAndSpots_oldVersion_2sets( dataStruct,coords2 )
...
%% LOCAL FUNCTIONS
    ...
    function plotPlanes(figH,initialPlot,key)
        ...
        spots2 = imageInfo.spots2(currentTimePoint).allCoordPix;
        
        spots = spots((spots(:,3) < (currentZSec+0.5) & spots(:,3) > (currentZSec-0.5)),:);
        spots2 = spots2((spots2(:,3) < (currentZSec+0.5) & spots2(:,3) > (currentZSec-0.5)),:);
