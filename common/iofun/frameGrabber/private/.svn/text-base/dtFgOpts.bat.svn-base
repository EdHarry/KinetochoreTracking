...
rem *******************************************************************
rem Add include of dtFg
rem *******************************************************************
set INCLUDE=c:\FGSDK32\include;c:\usr\danuser\soft\include;%INCLUDE%
...
rem ********************************************************************
set LINKER=link
set LINKFLAGS=/dll /export:mexFunction %LIB_NAME%1.lib /implib:%LIB_NAME%l.lib /libpath:"c:\Fgsdk32\Lib" /libpath:"c:\usr\danuser\soft\lib"
set LINKOPTIMFLAGS= 
