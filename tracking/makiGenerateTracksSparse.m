function dataStruct = makiGenerateTracksSparse(dataStruct)
% Edit of makiGenerateTracks to use the new tracker 'trackCloseGapsKalmanSparse'
% EHarry March 2012

% Currently: output does not compound the tracks like in the previous
% version for some reason, so do not use for now
